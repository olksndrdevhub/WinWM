...
| `Mod + Shift + F` | Toggle fullscreen mode for focused window |
| `Mod + S` | Swap with master window (stack layout only) |
| `Mod + Shift + T` | Toggle workspace layout between default and tabbed |
